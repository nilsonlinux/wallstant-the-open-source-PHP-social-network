...
$lid = "";
    ...
    $like->execute();
    $likebtn = "<span onclick=\"likeUnlike('$plike')\" style='color:#d6281b;font-size:30px' data-toggle='tooltip' data-placement='top' title='".lang('u_liked_this')."' id='punlike'><span class=\"fa fa-heart\"></span></span>";
